...
import { InternshipForm, InternshipFormData } from '@/features/admin/components/forms/InternshipForm';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-white mb-1">Internships</h1>
          <p className="text-sm text-zinc-400">Manage internship opportunities.</p>
        </div>
